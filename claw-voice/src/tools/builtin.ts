...
async function searchMemory(args: Record<string, string>): Promise<string> {
...
async function readWorkspaceFile(args: Record<string, string>): Promise<string> {
...
const SEARCH_MEMORY_DEF: ToolDef = {
  type: 'function',
  function: {
    name: 'search_memory',
    description:
...
export const BUILTIN_TOOLS: Record<string, ToolRegistration> = {
  search_memory: { definition: SEARCH_MEMORY_DEF, handler: searchMemory },
  read_file: { definition: READ_FILE_DEF, handler: readWorkspaceFile },
}
